...
public class PostActivity extends AppCompatActivity {
        ...
        if (imageUri!=null){
            ...
            uploadTask.continueWithTask(new Continuation() {
                ...
                public void onComplete(@NonNull Task<Uri> task) {
                    ...
                    DatabaseReference mHashTag=FirebaseDatabase.getInstance().getReference().child("HashTags");
    ...
    /*protected void onStart() {
        super.onStart();
        final ArrayAdapter<Hashtag> hashTagAdapter= new ArrayAdapter<>(getApplicationContext());
